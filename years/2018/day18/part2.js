const input = require('fs').readFileSync('./years/2018/day18/input.txt').toString().trim();
...
module.exports = () => {
    ...
    for (let i = 0; i < 1000; i++) {
        ...
        past.push(lumberCount * treeCount);
    }

    past = past.slice(416, 444);
    return past[(1000000000 - 416) % past.length - 1];
}